    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <a href="{{ route('sliders.trash') }}" class="text-danger">Trash Counter<i class="fa fa-arrow-right"></i></a>
            </div>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('counter.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <hr>
                        <input name="icon" type="text" value="{{ old('icon') }}" class="form-control select-haq-icon-input">
                    </div>
